...
class Command_36 extends Command {
    ...
    execute(bufIt) {
        ...
        //Track 1
        this.data.track1_data = bufIt.readNext(this.data.track1_len).toString('utf8');
        ...
        //Track 1
        this.data.track2_data = bufIt.readNext(this.data.track2_len).toString('utf8');
        ...
        //Track 1
        this.data.track3_data = bufIt.readNext(this.data.track3_len).toString('utf8');
